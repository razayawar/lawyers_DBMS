...
if(isset($_GET['id'])){
    $user_id = $_GET['id'];
    $fetch = "SELECT * FROM `lawyers` WHERE `id` = $user_id";
    ...
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="lawyers/lawyers.php" class="active"><i class="material-icons-two-tone">dashboard</i>Lawyers<span
                                class="badge rounded-pill badge-danger float-end">87</span></a>
                    </li>
                    <li>
                        <a href="../appointments/appointment.php"><i
                                class="material-icons-two-tone">calendar_today</i>Appoinments</a>
                    </li>
                    <li>
                        <a href="../customer/customers.php"><i
                                class="material-icons-two-tone">dashboard</i>Customers<span
        ...
        <form action="" method="post">
            <div class="form-group">
                <label for="">Lawyers Name</label>
                <input type="text" name="name" value="<?php echo  $row['name'];  ?>"
                    class="form-control">
                <label for="">Lawyers Email</label>
                <input type="email"name="email" value="<?php echo  $row['email'];  ?>"
                    class="form-control">
                <label for="">Lawyers Phone NO</label>
                <input type="text" name="phone" value="<?php echo  $row['phone'];  ?>" 
                    class="form-control">
                <label for="">Lawyers Address</label>
                <input type="text" name="address" value="<?php echo  $row['address'];  ?>" 
                    class="form-control">
                <label for=""></label>
                <input type="hidden" name="id" value="<?php echo  $row['id'];  ?>" class="form-control">
                <label for="">Lawyers Service</label>
                <input type="text" name="service" value="<?php echo  $row['services'];  ?>"
                     class="form-control">
                <br>
                <input type="submit" value="Update" name="submit" class="btn btn-primary px-5 py-3">
            </div>
        </form>
        </div>
        </div>
...
if(isset($_POST['submit'])){
    ...
    $update = "UPDATE `lawyers` SET `id`='$id',`name`='$name',`email`='$email',`phone`='$phone',`address`='$address',`services`='$service' WHERE `id` = '$id'";
    ...
    if($result == true){
        ?>
<script>
    window.alert("Your Record Is Successfully Updated");
