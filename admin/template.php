        ...
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="lawyers/index.php"><i class="material-icons-two-tone">dashboard</i>Lawyers<span class="badge rounded-pill badge-danger float-end">87</span></a>
                    </li>
                    <li>
                        <a href="customers/index.php"><i class="material-icons-two-tone">dashboard</i>Customers</a>
                    </li>
                    <li>
                        <a href="Appointments/index.php"><i class="material-icons-two-tone">calendar_today</i>Appointments<span class="badge rounded-pill badge-success float-end">14</span></a>
                    </li>
                    <li>
