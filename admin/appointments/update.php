...
if(isset($_GET['id'])){
    $user_id = $_GET['id'];
    $fetch = "SELECT * FROM `bookings` WHERE `booking_id` = $user_id";
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="date" name="date" value="<?php echo  $row['booking_date'];  ?>"
                    class="form-control">
                <label for="">Booking Starting Time</label>
                <input type="time"name="start" value="<?php echo  $row['start_time'];  ?>"
                    class="form-control">
                <label for="">Booking Ending Time</label>
                <input type="time" name="end" value="<?php echo  $row['end_time'];  ?>" 
                    class="form-control">
                <label for=""></label>
                <input type="hidden" name="address" value="<?php echo  $row['booking_id'];  ?>" 
                    class="form-control">
                <br>
...
if(isset($_POST['submit'])){
    ...
    $update = "UPDATE `bookings` SET `booking_id`='$id',`booking_date`='$date',`start_time`='$start',`end_time`='$end' WHERE `booking_id`= '$id'";
