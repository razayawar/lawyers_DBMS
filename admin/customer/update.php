...
if(isset($_GET['id'])){
    $user_id = $_GET['id'];
    $fetch = "SELECT * FROM `customers` WHERE `customer_id` = $user_id";
    ...
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="../lawyers/lawyers.php"><i class="material-icons-two-tone">dashboard</i>Lawyers<span
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="password"name="password" value="<?php echo  $row['cupassword'];  ?>"
                    class="form-control">
                ...
                <input type="text" name="address" value="<?php echo  $row['address'];  ?>" 
                    class="form-control">
                <label for=""></label>
                <input type="hidden" name="id" value="<?php echo  $row['customer_id'];  ?>" class="form-control">
                <br>
...
if(isset($_POST['submit'])){
    ...
    $update = "UPDATE `customers` SET `customer_id`='$id',`username`='$username',`cupassword`='$password',`name`='$name',`email`='$email',`phone_number`='$phone',`address`='$address' WHERE `customer_id`='$id'";
