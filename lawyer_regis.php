...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO `lawyers`(`name`, `email`, `phone`, `address`, `services`, `img`) VALUES ('$name','$email','$phone','$address','$service','$image_destination')";
    ...
    if ($result == TRUE) {
        ...
        <script>
            ...
            window.location.assign('lawyer_regis.php');
        </script>
        <?php
    }
...
<li class="nav-item"><a class="nav-link active" href="lawyer_regis.php">Lawyers registration</a></li>
...
<div>
<h1>Registrstion For Lawyers</h1>
</div>
<form action="lawyer_regis.php" method="post" enctype="multipart/form-data">
<div class="form-group">
  <label for=""></label>
  <input type="text" name="name" placeholder="Lawyers Name" class="form-control">
  <label for=""></label>
  <input type="email" placeholder="Lawyers Email" name="email" class="form-control">
  <label for=""></label>
  <input type="text" name="phone" placeholder="Lawyers Phone" class="form-control">
  <label for=""></label>
  <input type="text" name="address" placeholder="Lawyers Address" class="form-control">
  <label for=""></label>
  <input type="file" name="image" accept=".jpg, .jpeg, .png" placeholder="Lawyers Picture" class="form-control">
  <label for=""></label>
  <input type="text" name="service" placeholder="Lawyers Service" class="form-control">
  <br>
