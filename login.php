...
if(isset($_POST['submit'])){
    ...
    $login = "SELECT * FROM `customers` WHERE `email` = '$useremail' AND `cupassword` = '$password'";
    $result = $conn->query($login);
    $row = $result->fetch_assoc();

    if($row['email'] == $_POST['email'] AND $row['cupassword'] == $_POST['password']){
...
<li class="nav-item"><a class="nav-link" href="atty.html">Attorneys</a></li>
...
<div class="form-group">
  ...
  <br>
  <input type="submit" value="LOGIN" name="submit" class="btn btn-primary px-5 py-3">
  <a href="register.php" class="btn btn-primary px-5 py-3">
  Register
  </a>
  <a href="adminlogin.php" class="btn btn-primary px-5 py-3">
  Dash-Borad
  </a>
</div>
</form>
